...
class Client:
    ...
    def _connect_ui_callbacks(self):
        ...
        def on_inventory_sort(criteria: str):
            self._safe_create_task(self.message_sender.inventory_sort(criteria))
    ...
    def _on_customisation_apply(self, changes: dict) -> None:
        ...
        if changes:
            self._safe_create_task(self.message_sender.update_appearance(changes))
    ...
    def _process_movement(self):
        ...
        if direction:
            ...
            self._safe_create_task(self.message_sender.move(direction))

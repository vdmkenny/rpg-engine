...
class ReferenceDataManager(BaseManager):
    ...
    def _item_to_dict(self, item) -> Dict[str, Any]:
        ...
        return {
            ...
            "icon_sprite_id": item.icon_sprite_id,
            "equipped_sprite_id": item.equipped_sprite_id,
        ...
        async with self._db_session() as db:
            ...
            for item_enum in ItemType:
                ...
                stmt = pg_insert(Item).values(
                    ...
                    icon_sprite_id=item_def.icon_sprite_id,
                    equipped_sprite_id=item_def.equipped_sprite_id,

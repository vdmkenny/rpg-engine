...
class TestConcurrencyLoadTesting:
    ...
    async def test_high_concurrency_inventory_operations(self, session, game_state_managers):
        ...
        for player in players:
            ...
            await player_mgr.register_online_player(player.id, player.username)
    ...
    async def test_mixed_operations_load_test(self, session, game_state_managers):
                ...
                for i in range(100):
                    ...
                    if operation_type == "inventory":
                        ...
                        if random.choice([True, False]):
                            ...
                            await inv_mgr.set_inventory_slot(player_id, slot, item_id, 1, 0.9)
                        ...
                        if random.choice([True, False]):
                            ...
                            await equip_mgr.set_equipment_slot(player_id, slot_name, item_id, 1, 0.8)
    ...
    async def test_concurrent_slot_contention(self, session, game_state_managers):
        ...
        await player_mgr.register_online_player(player_id, "contention_player")
            ...
            try:
                ...
                for i in range(50):
                    ...
                    if operation == "set":
                        ...
                        await inv_mgr.set_inventory_slot(player_id, slot, item_id, 1, 1.0)

...
# =============================================================================
# SQLAlchemy Model Type Compatibility Tests
# =============================================================================
...
class TestSQLAlchemyModelCompatibility:
    ...
    async def test_item_stat_fields_are_integers(self, session: AsyncSession, gsm):
        ...
        assert isinstance(item.strength_bonus, int)
        assert isinstance(item.physical_defence_bonus, int)
        assert isinstance(item.magic_defence_bonus, int)
        assert isinstance(item.health_bonus, int)
        assert isinstance(item.magic_attack_bonus, int)
        assert isinstance(item.speed_bonus, int)
